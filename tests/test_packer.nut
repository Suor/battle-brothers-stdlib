...
// Structs
assertPack([{a = 1}, {a = 2}], "[2{1'1a,1}02");
assertPack([{a = 1, b = 2}, {b = 5, a = 7}], "[2{2'1a,1'1b,2}075");
assertPack([{a = 1}, {a = null}, {a = 2}], "[3{1'1a,1}0~}02");
assertPack([{a = null}, {a = 1}, {a = 2}], "[3{1'1a~}0,1}02");

// Structs: cint
assertPack([{a = 1}, {a = true}, {a = false}], "[3{1'1a,1}0|+}0-");
assertPack([{a = 1}, {a = -5}, {a = false}], "[3{1'1a,1}0+}0|-");  // -5 in cint is +
assertPack([{a = 1}, {a = false}], "[2{1'1a,1}0|-");
assertPack([{a = 1}, {a = -2}], "[2{1'1a,1}0.");  // -2 in cint is .
...
assertPack([{a = 1}, {a = {}}], "[2{1'1a,1}0|{0");
assertPack([{a = 1}, {a = {a = 2}}], "[2{1'1a,1}0|}02");  // cint -> struct, also nested
...
assertPack([{a = 1, b = {c = "hi"}}, {a = 5, b = {c = "bye"}}, {a = null, b = {c = "hi"}}],
    "[3{2'1a,1'1b{1'1c'2hi}05|}13bye}0~1*1")
assertPack([{a = null, b = null}, {a = {a = 1, b = 2}, b = {a = "x", b = "y"}}],
    "[2{2'1a~'1b~}0}0,1,2|}0|'1x|'1y")

assertPack([{a = "foo"}, {a = "bar"}], "[2{1'1a'3foo}03bar");
assertPack([{a = "foo"}, {a = "foo"}], "[2{1'1a'3foo}0*0"); // change op because of ref
assertPack([{a = "foo"}, {a = "foo"}, {a = "bar"}], "[3{1'1a'3foo}0*0}0'3bar"); // change op twice

// Structs: arrays and vectors
assertPack([{a = []}, {a = null}], "[2{1'1a[0}0~");
assertPack([{a = [7 7]}, {a = [8 8]}], "[2{1'1a]2,77}02,88");
assertPack([{a = [7 7]}, {a = "a"}], "[2{1'1a]2,77}0|*0"); // vector -> ref
assertPack([{a = [7 7]}, {a = [null 1]}], "[2{1'1a]2,77}0|[2~,1"); // vector -> array
assertPack([{a = [null 1]}, {a = [7 7]}], "[2{1'1a[2~,1}0|]2,77"); // array -> vector
assertPack([{a = [null 1]}, {a = array(45)}],
    "[2{1'1a[2~,1}0]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");  // 45is cint ]
