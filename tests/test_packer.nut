...
// Vectors of cint
assertPack([1 2 3], "]3!123", "@>2]3,123", "@>1[,3,1,2,3");
assertPack([1 null 3], "]3!1~3", "@>2]3,1~3", "@>1[,3,1_,3");
assertPack([null null 3], "]3~~!3", "@>2[3~~,3", "@>1[,3__,3"); // bail out in v2: no gain
assertPack([0 47], "]2!0_", "@>2]2,0_", "@>1[,2,0,_");         // check null op not confusing with cint 47
assertPack([3 100], "]2!3#:3", "@>2[2,3#3100");    // bail out: out of cint

// , used to be cint opcode, trying to mess with it. And also with # and ! opcodes
assertPack([85 86], "]2#+3,3", "@>2[2#285#286");
assertPack([85 77], "]2#+3z2");
assertPack([85 75], "]2#+3x2");
...
local t = {}; t[1] <- 42;
assertPack(t, "{1!1!Z", "@>2{1,1,Z", "@>1{,1,1,Z");
local t = {}; t[0.5] <- 21;
assertPack(t, "{1.30.5!E", "@>2{1.30.5,E", "@>1{,1.30.5,E");
...
assertPack({x = [3 7]}, "{1'1x]2!37", "@>2{1'1x]2,37", "@>1{,1'1x[,2,3,7")
assertPack([{a = 7, b = null}, {a = "hi", c = false}],
    "]2{2'1a!7'1b~2*1'2hi'1c-",
 "@>2[2{2'1a,7'1b~{2*1'2hi'1c-",
...
assertPack(["value", {key = 7}, {key = "value"}],
 ...
 "@>2[3'5value{1'3key,7}0|*1", // tests cint -> ref
